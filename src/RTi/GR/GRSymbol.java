...
public static GRSymbolShapeType [] getShapeTypes ( GRSymbolShapeTypeListContents listContents ) {
	...
	if ( listContents == GRSymbolShapeTypeListContents.APP_CHOICES ) {
		...
		GRSymbolShapeType [] shapeTypes = {
			...
			GRSymbolShapeType.CIRCLE_HOLLOW,
			GRSymbolShapeType.CIRCLE_FILLED,
			GRSymbolShapeType.CIRCLE_PLUS,
			GRSymbolShapeType.DIAMOND_HOLLOW,
			GRSymbolShapeType.DIAMOND_FILLED,
			GRSymbolShapeType.ELLIPSE_HORIZONTAL_HOLLOW,
			GRSymbolShapeType.ELLIPSE_HORIZONTAL_FILLED,
			GRSymbolShapeType.ELLIPSE_VERTICAL_HOLLOW,
			...
			GRSymbolShapeType.RECTANGLE_HORIZONTAL_HOLLOW,
			GRSymbolShapeType.RECTANGLE_HORIZONTAL_FILLED,
			GRSymbolShapeType.RECTANGLE_VERTICAL_HOLLOW,
			GRSymbolShapeType.RECTANGLE_VERTICAL_FILLED,
			GRSymbolShapeType.SQUARE_HOLLOW,
			GRSymbolShapeType.SQUARE_FILLED,
			GRSymbolShapeType.TEACUP,
			GRSymbolShapeType.TRIANGLE_DOWN_FILLED,
			GRSymbolShapeType.TRIANGLE_DOWN_FILLED_BOTTOM_LINE,
			GRSymbolShapeType.TRIANGLE_DOWN_HOLLOW,
			GRSymbolShapeType.TRIANGLE_DOWN_HOLLOW_BOTTOM_LINE,
			GRSymbolShapeType.TRIANGLE_LEFT_FILLED,
			GRSymbolShapeType.TRIANGLE_LEFT_HOLLOW,
			GRSymbolShapeType.TRIANGLE_RIGHT_FILLED,
			GRSymbolShapeType.TRIANGLE_RIGHT_HOLLOW,
			GRSymbolShapeType.TRIANGLE_UP_FILLED,
			GRSymbolShapeType.TRIANGLE_UP_FILLED_TOP_LINE,
			GRSymbolShapeType.TRIANGLE_UP_HOLLOW_TOP_LINE,
			GRSymbolShapeType.TRIANGLE_UP_HOLLOW,
