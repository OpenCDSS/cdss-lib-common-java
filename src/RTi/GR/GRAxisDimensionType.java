// GRAxisDimensionType - graph axis dimension
...
*/
public enum GRAxisDimensionType {
    /**
     * X-axis.
     */
    X ("X"),
     ...
     */
    private GRAxisDimensionType(String displayName) {
	 ...
	 */
	public static GRAxisDimensionType valueOfIgnoreCase(String name) {
	    if ( name == null ) {
	        return null;
	    }
	    // Currently supported values.
	    for ( GRAxisDimensionType t : values() ) {
