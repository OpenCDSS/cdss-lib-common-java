// GRLineJoinStyleType - enumeration of line join styles
...
Line join styles.
*/
public enum GRLineJoinStyleType {
    /**
     ...
     */
    private GRLineJoinStyleType(String displayName) {
	 ...
	 */
	public static GRLineJoinStyleType valueOfIgnoreCase(String name) {
	    if ( name == null ) {
	        return null;
	    }
	    // Currently supported values.
	    for ( GRLineJoinStyleType t : values() ) {
