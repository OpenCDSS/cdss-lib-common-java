// ----------------------------------------------------------------------------
// DataTestExpression_LessThanOrEqualTo - class that stores information for a 
...
/**
This class stores information for a less than or equal to expression.
*/
public class DataTestExpression_LessThanOrEqualTo
extends DataTestExpression {

/**
Empty constructor.
*/
public DataTestExpression_LessThanOrEqualTo() 
throws Exception {}
...
out.
*/
public DataTestExpression_LessThanOrEqualTo(DataTestExpressionDataModel model) 
throws Exception {
	super(model);
}
...
*/
public DataTestExpression_LessThanOrEqualTo(DataTestExpression e) {
	super(e);
}
