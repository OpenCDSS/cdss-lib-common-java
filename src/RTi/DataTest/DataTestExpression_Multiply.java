// ----------------------------------------------------------------------------
// DataTestExpression_Multiply - class that stores information for a 
...
/**
This class stores information for a multiplication expression.
*/
public class DataTestExpression_Multiply
extends DataTestExpression {

/**
Empty constructor.
*/
public DataTestExpression_Multiply() 
throws Exception {}
...
out.
*/
public DataTestExpression_Multiply(DataTestExpressionDataModel model) 
throws Exception {
	super(model);
}
...
*/
public DataTestExpression_Multiply(DataTestExpression e) {
	super(e);
}
