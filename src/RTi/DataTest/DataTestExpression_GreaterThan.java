// ----------------------------------------------------------------------------
// DataTestExpression_GreaterThan - class that stores information for a 
...
/**
This class stores information for a GREATER THAN expression.
*/
public class DataTestExpression_GreaterThan
extends DataTestExpression {

/**
Empty constructor.
*/
public DataTestExpression_GreaterThan() 
throws Exception {}
...
out.
*/
public DataTestExpression_GreaterThan(DataTestExpressionDataModel model) 
throws Exception {
	super(model);
}
...
*/
public DataTestExpression_GreaterThan(DataTestExpression e) {
	super(e);
}
