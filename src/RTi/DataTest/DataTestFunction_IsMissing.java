// ----------------------------------------------------------------------------
// DataTestFunction_IsMissing - a function which checks to see if the value in
// 	a time series at a date/time is a missing value.
// ----------------------------------------------------------------------------
...
*/
public class DataTestFunction_IsMissing
...
Empty constructor.  
*/
public DataTestFunction_IsMissing() 
throws Exception {
	super(1);
	setNumTS(1);
	int[] positions = { 0 };
...
/**
Copy constructor.  
@param f the DataTestFunction_IsMissing to copy.
*/
public DataTestFunction_IsMissing(DataTestFunction f) {
	super(f);

	DataTestFunction_IsMissing i = (DataTestFunction_IsMissing)f;
...
*/
public DataTestFunction_IsMissing(DataTestFunctionDataModel dataModel) 
throws Exception {
	super(dataModel, 1);
	setNumTS(1);
	int[] positions = { 0 };
...
public String getDefaultPositiveMessage() {
	return "IsMissing($TSID[0][$DATETIME])=$VALUE";
}
...
public String toString(DateTime dateTime) {
	...
	return "IsMissing([" + tsid + "])[" + date + "]: " + value;
}
