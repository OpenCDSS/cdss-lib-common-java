// ----------------------------------------------------------------------------
// DataTestExpression_GreaterThanOrEqualTo - class that stores information for  
...
/**
This class stores information for a greater than or equal to expression.
*/
public class DataTestExpression_GreaterThanOrEqualTo
extends DataTestExpression {

/**
Empty constructor.
*/
public DataTestExpression_GreaterThanOrEqualTo() 
throws Exception {}
...
*/
public DataTestExpression_GreaterThanOrEqualTo(DataTestExpression e) {
	super(e);
}
