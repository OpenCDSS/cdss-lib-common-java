...
/**
This class is used to contain all the information associated with one record in a DataTable.
The field values are stored as an array of Object (formerly List of Object).
The record field values must be consistent with the definition of the DataTable.
An example of defining a TableRecord is as follows.
Setting the record size initially improves performance because less memory adjustment is required:
<p>
...
The number of elements can increase as new items are added;
however, specifying the correct number at initialization increases performance.
