...
/**
This class stores one help index item, for use by URLHelp.
The item consists of a key, a topic description, and a URL.
The URLHelp.readIndex() function describes the index file format for help items.
@see URLHelp
*/
...
public String toString () {
	return "key:\"" + _key + "\" URL:\"" + _URL + "\" topic:\"" + _topic + "\"";
}
