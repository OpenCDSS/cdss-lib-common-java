//---------------------------------------------------------------------------
// MutableJList - class to allow an easily-changeable JList.
//---------------------------------------------------------------------------
...
*/
private MutableJList_SelectionModel __mjlsm = null;
...
@deprecated use SimpleJList
*/
public MutableJList(Object array[]) {
	super();
	__dlm = new DefaultListModel();
...
@deprecated use SimpleJList
*/
public MutableJList(Vector vector) {
	super();
	__dlm = new DefaultListModel();
...
public void deselectRow(int row) {
	...
	((MutableJList_SelectionModel)getSelectionModel()).deselectRow(row);
}	
...
private void initialize() {
	__mjlsm = new MutableJList_SelectionModel(getItemCount());
...
public void selectAll() {
	if (__ilsm != null) {
		...
		setSelectionInterval(0, __dlm.size());
	}
}
...
/**
Sets up the MutableJList as having an inverse list selection model (or not).
...
/**
Sets the model to use with this MutableJList.
