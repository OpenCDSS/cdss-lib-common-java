//---------------------------------------------------------------------------
// DragAndDropMutableJList - class that supports drag and drop operations 
// 	on a JList.
//---------------------------------------------------------------------------
...
// History:
//
// 2002-05-06	J. Thomas Sapienza, RTi	Initial version.
...
/**
@deprecated use DragAndDropSimpleJList
*/
public class DragAndDropMutableJList
...
archive this class
*/
public DragAndDropMutableJList(int dragAction, int dropAction) {
	super();
...
@deprecated use DragAndDropSimpleJList
*/
public DragAndDropMutableJList(Object array[], int dragAction, int dropAction) {
	super(array);
	initialize(dragAction, dropAction);
}
...
@deprecated use DragAndDropSimpleJList
*/
public DragAndDropMutableJList(Vector vector, int dragAction, int dropAction) {
	super(vector);
	initialize(dragAction, dropAction);
}
...
private void initialize(int dragAction, int dropAction) {
	...
	setSelectionModel(new MutableJList_SelectionModel(getItemCount()));
	((MutableJList_SelectionModel)getSelectionModel())
		.setSupportsDragAndDrop(true);
	getSelectionModel().addListSelectionListener(this);
	addMouseListener((MutableJList_SelectionModel)getSelectionModel());
}
...
public void dragGestureRecognized(DragGestureEvent dge) {
	...
	if (isSelectedIndex(row)) {
		if (((MutableJList_SelectionModel)getSelectionModel())
			.dragWasTriggered()) {
			DragAndDropUtil.dragStart(this, this, dge);
			Message.printStatus(1, "", "Drag Start");
		}
	}	
}
