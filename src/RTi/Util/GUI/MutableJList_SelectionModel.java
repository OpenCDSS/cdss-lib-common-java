// ----------------------------------------------------------------------------
// MutableJList_SelectionModel - Selection model for selecting items in a 
...
/**
Selection model for selecting items in a MutableJList.  Offers a lot more 
...
@deprecated use SimpleJList_SelectionModel
*/
public class MutableJList_SelectionModel
...
@deprecated use SimpleJList_SelectionModel
*/
public MutableJList_SelectionModel(int rows) {
...
//Message.printStatus(1, "", "addSelectionInterval(" + row0 + ", " + row1+")");
	__anchor = row0;
	__lead = row1;
...
//Message.printStatus(1, "", "** isSelectedIndex(" + row + "): false");
		return false;
	}
//Message.printStatus(1, "", "isSelectedIndex(" + row + "): " 
//	+ __cellsSelected[row]);
