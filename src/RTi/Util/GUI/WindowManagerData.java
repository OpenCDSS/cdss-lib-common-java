...
/**
The WindowManagerData class holds instance data for window instances managed by the WindowManager.
This allows multiple instances of the same window type to be opened with different data contents.
*/
