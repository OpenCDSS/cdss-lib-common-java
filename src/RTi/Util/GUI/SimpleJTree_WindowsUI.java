// SimpleJTree_WindowUI - class that allows control over whether JTrees can expand or collapse
...
/**
The kind of line style that the Tree should have.  See SimpleJTree.LINE_*
*/
...
the line style has been set to LINE_ANGLED.
LINE_HORIZONTAL is not yet supported.
...
the line style has been set to LINE_ANGLED.  LINE_HORIZONTAL is not yet supported.
@param g the Graphics context with which to paint the tree lines
@param c unused
