...
private int		_mode,		// Mode in which class was instantiated.
...
@param parent JFrame class instantiating this class.
@param label Label to display in the GUI.
@param mode mode in which this UI is to be used (i.e., OK, OK_CANCEL)
...
process different types of yes responses from the calling form.
*/
public TextResponseJDialog ( JFrame parent, String title, String label, int mode ) {
	super ( parent, true );
...
*/
public TextResponseJDialog(JFrame parent, String title, String label, String text, int mode) {
	super(parent, true);
