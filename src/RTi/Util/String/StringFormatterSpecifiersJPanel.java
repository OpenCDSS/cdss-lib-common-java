...
*/
StringFormatterType __defaultFormatter = StringFormatterType.C;
...
*/
public StringFormatterSpecifiersJPanel ( int width, boolean includeFormatterType, boolean includeBlankFormatterType,
    StringFormatterType defaultFormatter )
{
...
return the default
*/
public StringFormatterType getStringFormatterType ( boolean onlyIfVisible )
{
    if ( onlyIfVisible ) {
...
{   String selectedFormatterType = __formatterTypeJComboBox.getSelected();
    ...
    if ( formatterType == null ) {
        ...
        choicesList.add(__hint);
        choicesList.addAll(Arrays.asList(StringUtil.getStringFormatSpecifiers(true,false)));
    }
    __specifierJComboBox.setData(choicesList);
    __specifierJComboBox.setMaximumRowCount(choicesList.size());
}

/**
Select the formatter type.  Select the empty string if formatterType=null.
*/
public void selectFormatterType ( StringFormatterType formatterType )
{
    if ( formatterType == null ) {
