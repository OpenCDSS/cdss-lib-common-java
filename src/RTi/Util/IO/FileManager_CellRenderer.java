// FileManager_CellRenderer - class for rendering FileManager data in a JWorksheet.
...
/**
This class is a cell renderer for cells in FileManager JWorksheets.
*/
@SuppressWarnings("serial")
public class FileManager_CellRenderer
extends JWorksheet_AbstractExcelCellRenderer {

	/**
	The table model for which this class will render cells.
	*/
	private FileManager_TableModel tableModel = null;

	/**
	Constructor.
	@param tableModel the tableModel for which to render cells.
	*/
	public FileManager_CellRenderer ( FileManager_TableModel tableModel ) {
