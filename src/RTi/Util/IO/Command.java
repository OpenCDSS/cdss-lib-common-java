...
/**
Return a string representation of the command given the parameter string.
This is used to output an unpopulated version of the string ("") or use "..." for an abbreviated representation.
