...
/**
The DataFormat is a simple class used to hold information about data formatting (e.g., precision for output).
It is primarily used by the DataUnits class.
@see DataUnits
*/
...
private int	_precision;		// The number of digits of precision after the decimal point on output.
private int	_width;			// The total width of the format.

/**
Construct and set the output width to 10 digits, 2 after the decimal point, and use a %g format.
*/
public DataFormat () {
	initialize ();
}
...
@return The format string to use for output.  This is a C-style format string (use with StringUtil.formatString()).
...
@return The precision (number of digits after the decimal point) to use for formatting.
*/
