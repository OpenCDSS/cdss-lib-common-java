...
Currently the instance is immutable and copies of the DateTime data are copied
at construction.
...
public class DateTimeRange
{
    ...
    /**
     * Constructor.
     * @param start starting value in the range.  Can be null to indicate open-ended
     * range (from available start).
     * @param end ending value in the range.  Can be null to indicate open-ended
     * range (to available end).
     */
