...
/**
Add a WindowListener for TSViewFrame instances that are created.
...
public void processReportProduct( TSProduct tsproduct ) throws Exception {
	String routine = getClass().getSimpleName() + ".processReportProduct";
	String tsid;
	String tsalias;
	DateTime date1 = null;
	DateTime date2 = null;
	...
	for ( int isub = 0; isub < nsubs; isub++ ) {
		...
		// Get the file name for the subproduct.
