...
*/
private Hashtable __distributionParameters = null;
...
*/
public Hashtable getDistributionParameters ()
{
...
{   String genesis = "", message, routine = getClass().getSimpleName() + ".runningStatistic";
    ...
    Hashtable distributionParameters = getDistributionParameters();
...
*/
private void setDistributionParameters ( Hashtable distributionParameters )
{
