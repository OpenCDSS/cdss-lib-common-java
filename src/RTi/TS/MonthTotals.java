...
by TSUtil.getMonthTotals.  This class may be deprecated in the future (include in TSLimits?).
*/
...
/**
Default constructor.  Initialize to null data.  The arrays must be set by other code.
*/
public MonthTotals () {
	initialize ();
}
