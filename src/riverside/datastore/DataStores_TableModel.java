...
public class DataStores_TableModel extends JWorksheet_AbstractRowTableModel<DataStore>
{
	...
	*/
	...
	public final int COL_PLUGIN_JAR_FILE = 20;
	// Used for testing.
	public final int COL_SUBSTITUTE_TO_USE = 21; // Same as COL_NAME.
	public final int COL_SUBSTITUTE_IN_COMMANDS = 22;
	...
	*/
	public String[] getColumnToolTips() {
	    ...
	    tooltips[COL_PLUGIN_JAR_FILE] = "Plugin Jar File";
	...
	public Object getValueAt(int row, int col) {
	    ...
	    switch (col) {
	        ...
	        case COL_PLUGIN_JAR_FILE:
	        	if ( pluginDataStore != null ) {
	        		// Will be null or a String.
	        		return pluginDataStore.getPluginProperties().get("JarFile");
	        	}
	        	else {
	        		return "";
	        	}
	...
	*/
	public int[] getColumnWidths() {
	    ...
	    widths[COL_PLUGIN_VERSION] = 15;
	    widths[COL_PLUGIN_JAR_FILE] = 65;
